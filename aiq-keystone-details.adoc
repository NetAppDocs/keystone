...
[.lead]
If you have subscribed to NetApp Keystone services, you can monitor your usage on the *Keystone Subscriptions* widget on the Digital Advisor dashboard. 
...
* *Time series charts*: The bar charts display the service level name and the capacity usage against that service level for the time range. The date and time of the collection are displayed at the bottom of the chart. The bar charts appear in these colors to indicate usage:
...
* *Current Consumed*: The consumed capacity (in TiB) for the billing period with respect to a service level. The colors indicate the following usage:
** Grey: None
** Green: Within 80% of the committed capacity
** Amber: Any consumption above 80% of the committed capacity
* *Current Burst*:The consumed capacity for a service level that is within or above the defined burst limit. Any usage above 100% of the burst limit agreed upon, for example 20% above the committed capacity, is within the burst limit. Further usage is considered as usage above the burst limit . This chart displays specific colors to indicate the following usage:
** Grey: None
** Red: Burst 
