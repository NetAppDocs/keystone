...
. Select *Capacity Trend* if you want to view the historical data and analyze the capacity usage trend. Select *Accrued Burst* if you want to view the monthly burst usage data over the last year and analyze the data usage in your invoice.
...
=== View accrued burst data
.Learn more
[%collapsible]
====

Indicator for the accrued burst usage or consumed capacity calculated per month for the current billing period. The accrued burst usage is calculated based on the committed and consumed capacity for a service level: `(consumed - committed)/365.25/12`.
