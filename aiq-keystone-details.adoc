...
[.lead]
If you have subscribed to NetApp Keystone services, you can monitor your usage on the *Keystone Subscriptions* widget on the Active IQ Digital Advisor (Digital Advisor) dashboard.

[NOTE]
For ONTAP and StorgaGRID 

For information about the Keystone Digital Advisor widget, see https://docs.netapp.com/us-en/active-iq/task_view_keystone_capacity_utilization.html[View capacity utilization with NetApp Keystone Subscription^].
...
.Volume details in ONTAP
[%collapsible]
====
For ONTAP, the *System Details* tab displays the volume details in your storage environment managed by a Keystone subscription. Information, such as the capacity usage, volume type, cluster, aggregate, and service level, is displayed.
...
.Nodes and consumption details in StorageGRID
[%collapsible]
====
For StorageGRID, the logical usage for the nodes in the object storage environment is displayed.
