...
* *End date*: The end date of the subscription. If a subscription has no end date, and it gets renewed automatically, you see `Month-on-month` instead of the date. Based on this date, you might see information messages for subscriptions that are nearing expiry or have auto-renewal policies attached. 
