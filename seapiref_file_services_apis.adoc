...
You can use File Servers APIs to view and manage your file servers. For more information on file servers, see link:sewebiug_create_a_file_server.html[Create a file server].
...
`size_gb`: The size of the file share in Gibs.
