...
[.lead]
NetApp Keystone data protection service refers to methods that support back up of data and the ability to recover if required. Available data protection services include (Table 2):
