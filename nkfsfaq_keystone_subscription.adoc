...
Yes, new storage service or expansion to storage service can be requested thourgh KSMs. The request is processed by the NetApp Keystone operations team before making it available for use.
