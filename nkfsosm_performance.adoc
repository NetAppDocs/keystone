...
=== File shares
*Supported protocols*: NFS, CIFS, iSCSI, FC, and S3 (Object)
...
[NOTE]
^1^ Minimum one-year term and 100TiB minimum capacity across combination of any File and Block performance levels for NetApp direct opportunities.
