...
.. Specify the Windows permission. The default value is `Full control`. In case a user is a part of two groups, the permissions of the group that has higher privileges get applied on the user's access.
