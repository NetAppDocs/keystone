...
* To enable disaster recovery options for the share, you must create the share on a server that is disaster recovery enabled. For more information, see link:sewebiug_billing_accounts,_subscriptions,_services,_and_performance.html#disaster-recovery[Disaster recovery].
