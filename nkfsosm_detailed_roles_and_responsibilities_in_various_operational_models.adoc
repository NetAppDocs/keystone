...
Table 3 lists the service SLOs and SLAs in a NetApp- partner operated model. 
...
In a KFS NetApp-  or partner-operated model,  the SupportEdge Expert level is leveraged and the following SLAs are offered (Table 4):
...
Table 5 lists the service SLOs and SLAs in a customer-partner operated model. 
...
In a KFS NetApp-  or customer-operated model,  the SupportEdge Advisor support level is leveraged and the following SLOs are offered (Table 6):
...
* Performance of the NetApp-operated services includes, without limitation, NetApp assuming the responsibilities listed in Table 7 as reasonably applicable to the supported environment.
