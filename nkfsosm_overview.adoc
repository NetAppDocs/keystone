...
= Flex Subscription operation model
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
NetApp Keystone Flex Subscription (Flex Subscription) offers three operational models:
...
The bellow figure summarizes the overall service lifecycle model and categorizes the associated services.
