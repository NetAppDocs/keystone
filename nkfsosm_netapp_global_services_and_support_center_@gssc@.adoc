...
The KSM is the primary contact for the customer to manage the overall Flex Subscription service. The KSM works with various stakeholders within NetApp and with the customer.
