...
[NOTE]
[2.6.2]The capacity utilization data is regenerated every 15 minutes. You can use the refresh button image:refresh-icon.png[refresh icon] on top of the dashboard to refresh the data at intervals.
