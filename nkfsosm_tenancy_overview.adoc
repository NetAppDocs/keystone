...
* [2.6.2]The tenant administrator can use only the service levels that are assigned to them by the service provider, and not any other service level, irrespective of whether or not the service provider has subscribed to those service levels.
