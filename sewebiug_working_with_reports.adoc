...
[2.6.2]To view the capacity usage report for each subscribed service level, you can take the CSV output by clicking the download icon image:download_icon.png[download icon] for a line item.
