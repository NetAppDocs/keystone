...
NetApp Service Engine now has the ability to support Cloud Volumes Services (CVS). It can now support Azure NetApp Files.
...
*	Provisioning or modifying the CVS volumes (including the ability to take snapshots)
*	Backing up data to a CVS zone
*	Viewing CVS volumes in NSE inventory
*	Viewing CVS usage.
