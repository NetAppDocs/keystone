...
=== Ability to view your Cloud Volumes ONTAP usage and subscription

If you are a NetApp Keystone Flex Subscription customer, and also have Cloud Volumes ONTAP subscription, you can view the usage and billing on your cloud volumes through the Cloud Manager interface. Cloud Manager can now discover your NetApp Keystone Flex Subscriptions and retrieve your subscription details. On clicking the *All Services > Digital Wallet > Keystone Flex Subscription* tab, you can perform the following activities:
...
* View the consumption reporting for the committed and consumed capacities of the subscribed service levels for your on-premise systems and Cloud Volumes ONTAP subscriptions.
...
* Associate your Cloud Volumes ONTAP account with your Flex Subscription IDs to designate the account for billing and capacity usage reporting.
* Request increasing or decreasing the committed capacity for the subscribed Flex Subscription services.
* View the linked Flex Subscription ID as a charging method for billing the Cloud Volumes ONTAP consumption (only linked IDs).
