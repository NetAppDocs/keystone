...
== Features introduced in NetApp Keystone Flex Subscription 2.1

=== Keystone for Service Providers

NetApp Service Engine now supports the management of a multi-tenant environment by a service provider. You can perform the functions of provisioning, reporting, billing, and managing customers having their own subscriptions.
