...
All capacity units and calculations in NetApp Service Engine APIs are converted to GiB/TiB/PiB from GB/TB/PB. This is in keeping with the existing metrics on the user interface.
