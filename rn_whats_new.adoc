...
The new features in this release include supporting multi-tenancy in a Flex Subscription environment and tiering capabilities in which the inactive data can moved to the lower cost local or cloud tier.
...
+
.API support:
You can use the `/reports` API to view the reports for your respective tenancies.
+
