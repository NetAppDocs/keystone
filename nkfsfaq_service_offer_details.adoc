...
In this case, the new subscription does not co-term with the old subscription. At the time when the new subscription for the backup site is added, the terms of the first subscription are updated with your agreement to extend its term by the time after which the new subscription is added.
