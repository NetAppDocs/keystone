...
A subscription might only have one of each performance service level, for example, if your subscription already contains an Extreme and a Standard service, you can add a Premium or Block service.
